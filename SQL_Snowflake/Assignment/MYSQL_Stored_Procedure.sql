Create schema Store_procedure_my_sql;
Use Store_procedure_my_sql;  
...
-- first procedure to select all the records
...
DELIMITER &&
create procedure technician_delete()
BEGIN
...
drop procedure AVG_BAL_JOBROLE1;
